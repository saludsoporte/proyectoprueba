...
class LibrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libro" do
    assert_difference("Libro.count") do
      post libros_url, params: { libro: { autor_id: @libro.autor_id, editorial: @libro.editorial, fechaPub: @libro.fechaPub, nombre: @libro.nombre } }
    end
  ...
  test "should update libro" do
    patch libro_url(@libro), params: { libro: { autor_id: @libro.autor_id, editorial: @libro.editorial, fechaPub: @libro.fechaPub, nombre: @libro.nombre } }

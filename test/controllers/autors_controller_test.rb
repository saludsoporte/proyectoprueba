...
class AutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create autor" do
    assert_difference("Autor.count") do
      post autors_url, params: { autor: { nombre: @autor.nombre, telefono: @autor.telefono, titulo: @autor.titulo } }
    end
  ...
  test "should update autor" do
    patch autor_url(@autor), params: { autor: { nombre: @autor.nombre, telefono: @autor.telefono, titulo: @autor.titulo } }
